...
namespace ThePipeCat.Persona
{
    ...
    public class PersonaProfile : ScriptableObject
    {
        ...
        [SerializeField]
        private PersonaInventory m_InventoryProfile; // Shared
        ...
        private void Awake()
        {
            // Copy inventory to the memory:
            if (m_InventoryProfile != null)
                m_Inventory = Instantiate<PersonaInventory>(m_InventoryProfile);
        }
